...
class CrossEMAStrategy(IStrategy):
    ...
    GitHub : https://github.com/CryptoRobotFr/TrueStrategy/blob/main/Cross%20EMA%20+%20stoch%20RSI#1/Cross_EMA_+_stoch_RSI_TrueStrategy_1.ipynb
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['ema28']=ta.EMA(dataframe, timeperiod=28)
